...
import CenterImage from "../assets/images/scroll.png";

const images = [
  { src: img1, top: "-5%", left: "2%", size: 300, depth: -1.2 },
  { src: img2, top: "15%", left: "12%", size: 180, depth: 0.5 },
  { src: img3, top: "2%", right: "5%", size: 280, depth: -0.8 },
  { src: img4, top: "20%", right: "18%", size: 160, depth: 1.4 },
  { src: img5, bottom: "8%", left: "4%", size: 320, depth: 1.6 },
  { src: img6, bottom: "22%", left: "20%", size: 200, depth: -0.4 },
  { src: img7, bottom: "-2%", right: "6%", size: 340, depth: 0.9 },
];
            ...
            {images.map((img, i) => (
              <img
                ...
                style={{
                  ...
                  // ✅ Reduced blur (~1%)
                  filter: `blur(0.6px) brightness(${img.depth < 0 ? 0.85 : 1.05})`,
