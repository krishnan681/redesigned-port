...
const AboutMe = () => {
  const skillGroups = [
    ...
    },
    {
      ...
      description:
        "Frameworks and tools for building cross-platform mobile apps",
      skills: [
      ...
      skills: [
        {
          ...
          icon: (
            ...
            >
              ...
              <path
                fill="#66bb6a"
                d="M18,45c-3.866,0-7-3.134-7-7v0c0-3.866,3.134-7,7-7h7v7c0,3.866-3.134,7-7,7z"
              />
              <path
                fill="#ff7043"
        ...
        },
        {
          ...
          icon: (
            <img
              src="https://img.icons8.com/?size=96&id=9kTbRIN6cDXX&format=png"
              alt="CorelDRAW"
    ...
    },
    {
      ...
      description:
        "Practical skills applied during development and project execution",
      isDetailed: true,
      skills: [
        {
            ...
            <div key={groupIndex} className="skill-category">
              ...
              <div
                className={`skills-list ${
                  group.isDetailed ? "detailed-list" : "icon-list"
                }`}
              >
